...
(async () => {
  ...
  try {
    ...
    assert(await page.locator('#submission-status.error .fa-times-circle').isVisible());
    ...
    assert(await page.locator('#submission-status.success .fa-check-circle').isVisible());
    await page.reload();
