...
Shared CTFd pages use dark headings and body text on cream or white. Muted text is `#465365`, links `#164d9e`, errors `#982c21`, and success text `#255b20`. White labels use darker blue/green chrome. Charts use explicit white backgrounds, dark labels, and a series palette with minimum 6.8:1 contrast against white. Category/solve indicators use the same darker palette. `dev/contrast.cjs` checks rendered text; browser screenshots cover the XP prompt, scoreboard and profile charts.
